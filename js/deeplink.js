// Parse and build ?youtube=ID&play=BOOL deeplinks.
...
export function parseDeeplink() {
  ...
  return { videoId, play: parsePlayFlag(params.get("play")) };
}

export function buildDeeplinkUrl(videoId, { play = false } = {}) {
...
export async function shareDeeplink(videoStore, notify) {
  ...
  const url = buildDeeplinkUrl(videoId);
